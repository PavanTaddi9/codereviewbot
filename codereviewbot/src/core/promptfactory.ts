...
export namespace PromptFactory {
    export function makeAskCodePrompt(
        PR: string,
        PRdes: string,
        issue: string,
        issdes: string,
        ...
        prompt.pushSystem(`
            ...
            performance optimization, security, and maintainability. Your task is to analyze the provided 
            pull request (PR) and generate a review with actionable feedback. Based on your understanding 
            of the PR, provide one of the following responses:
        ...
        prompt.pushUser(
            `Hey, I have the following pull request details along with its associated issue and code changes. 
            Can you please analyze the PR and provide a review based on the given details?  
